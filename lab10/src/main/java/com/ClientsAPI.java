...
public class ClientsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = userObj.createClient( 
				 request.getParameter("clientName"), 
				request.getParameter("clientAddress"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = userObj.updateClient(paras.get("hidClientIDSave").toString(), 
		paras.get("clientName").toString(),
		paras.get("clientAddress").toString(), 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		UserModel userObj = new UserModel(); 
		Map paras = getParasMap(request); 
		 String output = userObj.deleteClient(paras.get("connectionNo").toString()); 
		response.getWriter().write(output); 
